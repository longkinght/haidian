...
iteration: "v6.0-professional-rebuild"
---

# THE SWITCH 2.0

## I. Reviewer brief and evidence index

### The decision in one paragraph

SWITCH is not an AI device. It is a **legible, measurable, contestable, and withdrawable** public test line: it switches one ordinary person’s vague discomfort into a spatial action, and binds every decision to an owner, evidence, and an exit condition. Space is intervened in only where necessary; data moves only inside an authorized boundary; an unresolved item stops the next move.

| Reviewer question | This proposal decides | Check directly |
|---|---|---|
| What is the spatial spine? | One north-south public spine links Zhongzhiyuan, AI Origin, and Dazhongsi as three yards with different duties; three east-west interfaces repair school–community, rail–park, and industry–daily-life breaks | `geometry/roads.geojson`, overview, key-area drawings |
| What does AI change? | AI generates candidates, exposes assumptions, and organizes feedback; final choice, human service, professional approval, and the stop right remain public | `switch-protocol.json`, scenario cards, release gates |
| How does it open? | Eighteen conceptual projects are grouped into six launch packages; year one opens only a reversible 100-metre demonstration, one red-card drill, and three no-permanent-construction pilots | `catalogs.json`, `phasing.geojson`, annual ledger |
| How are claims bounded? | Recalculable geometry, contextual references, and first-year measurements are separated; provisional, unknown, and future-validation states remain visible in text and drawings | `metrics.json`, `assumptions.json`, risk register |

### Reading path for review

1. Read this page and the next: one person, three yards, and the first 100 metres.
2. Read the A3 booklet and A0 boards: spatial hierarchy, scenarios, landmarks, packages, phases, and stop conditions.
3. Open the HTML and JSON: layers, metrics, sources, assumptions, owners, and version relationships.

Drawings are the explanation layer; GeoJSON, matrices, and metrics are the evidence layer. They must describe the same proposal. `visual/assets/catalogs.json` is the single catalog for landmarks L1–L5 and projects P01–P18. If a name, count, or anchor changes, the narrative, web pages, drawings, and matrices must change together [data:visual/assets/catalogs.json#landmarks] [data:visual/assets/catalogs.json#renewal_projects].

### Evidence states at a glance

| State | The package can say | The package cannot say |
|---|---|---|
| Formed | Text, drawings, structured protocols, and the deterministic generation chain exist | A field-test result exists |
| Provisional model | Submitted geometry supports relationships, concept generation, and recalculation | An official red line, approval, or construction exists |
| Unknown | Official boundaries, ownership, slow-variable baselines, and engineering conditions are explicitly pending | A synthetic scenario fills the gap |
| Future validation | Authorized parties, professionals, and affected groups must review later | Effects, acceptance, or performance can be claimed now |
...
### Failure return chain: what happens when it fails
...
### A public test line that can pause
...
## III. Design Basis and Source List: Three-Level Scope Framework
...
## IV. Coordinated Research Area: Industry and Future City Research
...
## V. Overall Design Area: Urban Renewal and Regulatory-Plan-Level Urban Design
...
## VI. Detailed Design of Key Areas
...
## VII. AI Innovation Ecosystem, Personas, and AI+ Scenarios
...
## VIII. Land Use, Building Scale, and Retain-Renovate-Demolish Strategy
...
## IX. Transport, Rail, Municipal Infrastructure, and Public Services
...
## X. Blue-Green Network, Public Space, and Urban Character
...
## XI. Renewal Projects, Implementation Policy, and Phasing
...
## XII. Metrics, Area Recalculation, and Compliance Matrix
...
## XIII. Risk, Copyright, and Compliance
