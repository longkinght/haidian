...
**OPEX。** 人力按 5 FTE × 每人每年 12–18 万元计（参赛者自设综合用工成本，含保险与培训），为 60–90 万元；能耗、耗材、设备校准与保险约 30–60 万元；合计约 90–150 万元/年，同样是参赛者自设、非报价。P2 列入 0 至 1 年清单的前提，是这笔年度开销被写进运营接力，而不是只写进效果图 [metric:p0_opex_low_million_cny_per_year] [metric:p0_opex_high_million_cny_per_year]。
