---
title: "Jing-Zhang Civic Interlocking: A Capable City, Governed by Its People"
...
# Jing-Zhang Civic Interlocking: A Capable City, Governed by Its People
...
“City as Agent” is neither software vocabulary pasted onto the city nor a proposal to hand the city to a super-AI. V9 turns the railway's engineering metaphor into urban design: railway interlocking prevents conflicting routes; **Civic Interlocking** permits visible AI shadow action only when five conditions align—public baseline, named human, rights and scope, legible evidence, and recovery readiness. This is not a claim to apply railway signalling technology or a safety certification. It makes “when the city must not act” visible in plan, section, signal state and responsibility contract. [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK] [depth:overall_spatial_structure]
...
Figure 1 uses named Amap coordinates to anchor three experiences but never upgrades points into a boundary, ownership or engineering conclusion. Three normalized plans show two removable shadow bays S1/S2 and the always-available ordinary/staffed H line; the five locks below are release prerequisites. Final position, clear width, gradients, crossings and heritage relationships require G0 field verification. [source:AMAP-SPATIAL-SNAPSHOT-20260821] [data:visual/assets/civic-interlocking-spatial-topologies.json]
...
![Four competing design roots and their hard-gate comparison](assets/figures/land-use-structure.en.png)
...
### V9 anchor check: three independently useful segments, not one promised continuous walk
...
V9 turns taskbook coverage into six handover contracts. Each names its spatial object, users, operator, evidence, stop condition and next professional owner. Institutional roles remain suggestions until authorised. [source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
