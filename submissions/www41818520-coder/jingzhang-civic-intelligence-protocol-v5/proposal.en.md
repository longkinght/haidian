...
V5 turns taskbook coverage into six handover contracts. Each names its spatial object, users, operator, evidence, stop condition and next professional owner. Institutional roles remain suggestions until authorised. [source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
