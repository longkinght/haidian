...
const proto=load("civic-intelligence-task-protocol.json"),contracts=load("implementation-contracts.json"),rights=load("public-rights-matrix.json"),claims=load("claim-provenance.json");
...
console.log(`PASS stages=${proto.stages.length}/6 key_areas=3/3 gates=4/4 projects=8/8 contracts=${contracts.first_issue_contracts.length}/3 rights=${rights.rights.length}/7 claims=${claims.claims.length}`);
