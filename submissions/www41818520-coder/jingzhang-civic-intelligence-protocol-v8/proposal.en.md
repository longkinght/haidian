...
### V8 anchor check: three independently useful segments, not one promised continuous walk
...
V8 turns taskbook coverage into six handover contracts. Each names its spatial object, users, operator, evidence, stop condition and next professional owner. Institutional roles remain suggestions until authorised. [source:AGENT-TASKBOOK] [standard:PROJECT-AGENT-OPEN-CALL-TASKBOOK]
