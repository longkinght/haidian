...
summary: "一个真实使用者提出到达难题，一项AI服务携证据经过安全、可理解、真实首用三道公共闸门；六个横向入口把这套可暂停、可迁移、可退场的规则接入百年京张。"
...
一句话提案：**让百年京张成为 AI 进入真实城市之前的公共首发线：人先定义问题，普通空间先成立，AI 凭证据过三关，公众决定扩展、暂停或退场。**
...
## 90秒看懂：一个人、一个真实问题、三道公共闸门

**林岚是合成角色，代表需要陪长者出行的乘客。**她从13号线大钟寺站A口方向出发，希望经1733到达12号线D口；面对地面、商业多层界面、站口状态和非机动车边缘，她首先需要的不是一个新App，而是一条实体可见、有人可问、无障碍替代经核验的普通路线。这个问题来自2026年8月13日一次傍晚现场观察，但林岚本人不对应任何真实人物。[source:USER-FIELD-DAZHONGSI-20260813] [data:geometry/public_space.geojson#SCN-03]

林岚留在大钟寺参加问题定义、路线共测和最终共评；沿线传递的是她的问题、一项待上街的多语/无障碍信息服务，以及随行证据。众智园只有在测试范围、实体急停、近失记录与撤场线清楚时才盖 `PROVE`；AI 原点社区只有在林岚能复述用途、局限、人工责任和撤回方法时才盖 `TRANSLATE`；大钟寺只有在实体图、人工服务和连续通行先成立时，才允许自愿、限时、可关闭的 `FIRST USE`。最后，成功、暂停和失败以同一张结果卡回到公共账本。[metric:journey_stage_count]
...
![一个人提出真实问题，一项AI服务如何凭上街票走到首用决定](assets/figures/street-pass-journey.png)

以上流程是帮助专业讨论的概念情景，不代表既有运营、已获授权日程或绩效。这里的“最后500米”指研究成果获得普通人、小组织与维护人员理解和信任的最后一段转化，不是精确服务半径。

### 三句话落地

1. **设计对象：**不另造一条“AI大道”，而是在遗址公园、公共首层和站城界面上增加不占主线、可移动的服务侧袋。
2. **第一步：**在大钟寺 `T0` 现状时态先组合 `SP-01上街票 + SP-04可迁移站城接口 + SP-05无障碍同行`，用一个90天概念决策序列证明普通到达能否成立。
3. **成功标准：**AI关闭或撤走后，路线、人工服务、花园、院落和商业公共界面仍然更清楚、更舒适、更好维护。
...
| 首期交付什么 | 先在大钟寺组合 SP-01/04/05；其余8个行动包按“0–6月可逆原型、6–18月证据后复制、18–36月网络复盘”组织，并标注 S/M/L 概念资源量级 | 交付闸门图、90天决策门、行动包表、`visual/assets/pilot-matrix.json` |
...
资源量级只帮助专业团队判断组织复杂度，不是投资估算：`S` 表示复用既有场地、移动工具包和一个运营班次；`M` 表示约100米受控范围、临时服务条件与跨专业复核；`L` 表示多节点复制、持续运营、年度维护与备件。所有量级仍须另行测算和授权。

| 行动包 | 首期交付物 | 概念资源量级 | 可被授权牵头 / 必要共同复核 | 不得开始与停止条件 | 验收证据 |
| --- | --- | --- | --- | --- | --- |
| SP-01 上街票与状态板 | schema、纸面票、公开状态字段、申诉/恢复模板 | S｜既有场地+移动工具包+单班运营 | 公共运营负责人 / 法务、隐私、无障碍、受影响者 | 无人工窗口、无非 AI 路径、责任人不可见则不得上线 | 三章记录、申诉回执、停止演练 |
| SP-02 众智园验证庭 | 可逆验证环、安全员窗、急停/近失记录 | M｜100米受控口袋+安全/维护复核 | 验证场运营者 / 安全、交通、维护岗位 | 无地理围栏、无急停、漏报碰撞/近失即停止 | 接管时延、近失闭环、撤场恢复 |
| SP-03 原点转译窗 | 模型卡架、人工解释台、共测预约与结果卡 | S｜既有公共首层+人工解释班次 | 成果转译运营者 / 研发者、居民、小组织 | 不能普通语言解释或不能撤回数据则不盖章 | 理解度复核、人工纠正、需求回流 |
| SP-04 大钟寺可迁移站城接口 | T0/T1/T2路线版本、实体图、人工台、运营状态板、可迁移多语/无障碍建议侧袋 | M｜多点路线审计+移动台+跨方复核 | 轨道/场地/片区可被授权运营者 / 使用者、无障碍、交通、消防、维护和数据专业方 | 入口或通道变化未复核、普通路线或人工服务不成立、占主线或无维护人即停止 | 版本更新时间、到达完成、人工纠正、暂停回执、迁移/撤场恢复 |
| SP-05 无障碍同行链 | 连续路线审计、实体地图、人工求助、休息点 | M｜连续路线审计+人工协助+修复清单 | 公共空间运营者 / 使用者、无障碍专业方 | 阻断主链、无求助或默认追踪即停止 | 断点关闭、响应时间、非 AI 路径可用 |
| SP-06 十二站服务组件 | 人工窗口、双高台面、低亮状态、检修与退出指引 | L｜多节点复制+年度运维与备件 | 点位运营者 / 园林、市政、维护、公众 | 占用通行、数字屏不可关、维护无岗位即撤除 | 巡检、故障降级、普通使用恢复 |
| SP-07 可纠错贡献里程碑 | 贡献墙、开源成果节点、全球开发者墙的版本化记录模板 | S｜开放模板+策展/权利核验 | 公共策展运营者 / 权利人、档案、公众复核 | 无来源/许可/证据，或把投稿误写成入选即不得展示 | PR/commit、贡献类型、许可、版本、纠错记录 |
| SP-08 四季运营与公开复盘 | 问题征集、共测、开源首发、维护者复盘的年度运行包 | M｜年度运营团队+四季活动与公开复盘 | 年度运营者 / 社区、高校、企业、国际参与者 | 没有归档、失败复盘和退出通道则不扩大活动 | 公开问题、结果卡、失败库、次年修订 |

### 第一件可被接手的事：大钟寺90天证伪试点

首期只组合 `SP-01 + SP-04 + SP-05`，概念资源量级为 `M`：复用既有公共界面，配置可移动实体图/人工台，组织分时路线和无障碍审计，并由使用者、维护者、专业复核者与可被授权运营者共同签结果卡。90天只是一段适用于任一有效时态的概念决策序列，不是获批工期、预算、采购或真实试点。开始前先确认当前属于T0现状、T1施工还是T2未来整合；入口或通道一变，计时暂停并回到D0–15。其价值是让专业团队知道“第一天做什么、什么证据才进入下一步、失败后交还什么”；结构化决策门随包保存在 `visual/assets/dazhongsi-90-day-gates.json`。
