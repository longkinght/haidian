...
All three fall within the regulatory detailed planning area of the Jingzhang Railway Heritage Park corridor (AI Innovation Street Key Area, blocks HD00-1601 etc.); Lanjing Lijia (HD00-1603-01) has official planning conditions (FAR 2.45 / height limit 60m, document Jing-Gui-Zi (Hai) Gong-Shen-Han [2025] No. 0006), and Xueyuan Road North A/B/C/J plots have land-use and document numbers (2018-Gui-Tu (Hai) Tiao-Gong-Zi No. 0001); see `visual/assets/plot-conditions.json`. Boundaries remain conceptual polygons; size, retain/renovate/demolish, road interfaces, and building form express direction only; after the regulatory plot schedules and official boundaries replace them, area, conflict, and accessibility are recalculated [metric:key_area_count] [depth:three_key_area_detailed_design].
