---
title: "Jing-Zhang City Version: An AI Innovation Belt Renewal Mechanism Grounded in Jing-Zhang Heritage and the Completed Park"
author_github: "Sh7ne"
language: "en"
...
On 6 August 2026, Phase II of the Jing-Zhang Railway Heritage Park opened in full. The newly reported baseline is an approximately 9 km corridor from Xizhimen to the North Fifth Ring Road, covering about 53 ha, adjoining 70 communities and about 450,000 residents; approximately 2.4 km of old track was restored in the southern section. These published quantities describe overall scale, not an as-built survey, asset register, or modelled service catchment. This proposal therefore updates its starting point from a Phase I North sample to a fully open public infrastructure corridor, and shifts design attention to transverse connections, cross-season operations, and renewal of existing interfaces. [source:JZ-PARK-PHASE2-OPEN-20260806] [metric:built_corridor_length_km] [metric:built_corridor_area_ha]
...
Haidian District's Fifteenth Five-Year Plan organizes the Beijing AI Origin Community, Zhongguancun AI North-Latitude Community, and the Centennial Jing-Zhang AI Innovation Belt as **Two Zones and One Belt**. It also calls for a loop of policy design, implementation, evaluation, and optimization, together with sandbox entry and exit mechanisms. This gives City Version a formal policy context: Jing-Zhang is not a stand-alone technology landscape but a validation belt linking knowledge creation, industrial translation, and real urban problems. The published positioning and eight service categories of the AI Origin Community inform the innovation ecosystem, not parcel or building design. [source:HAIDIAN-FIFTEENTH-FIVE-YEAR-PLAN-2026] [source:AI-ORIGIN-COMMUNITY-20260324]

Public reporting in August 2026 also states that block-level Regulatory Detailed Planning for nine blocks along the corridor, covering approximately 1,668.2 ha, has been approved with a structure of One Belt, One Axis, Two Centres and Multiple Nodes. Because the approved text, drawings, and statutory control schedules have not entered the repository source registry, this proposal treats the information only as background pending registry review and does not infer boundaries, FAR, heights, or parcel controls from a news report. [source:HD-JINGZHANG-BLOCK-PLAN-20260811]
...
![Jing-Zhang City Version: public baseline and three decision testbeds](assets/figures/site-overview.en.png)
...
This round must determine where along the approximately 9 km fully open park to prioritize adding shade, adjusting water and seating, changing operating times, or reducing facilities. The 12 themed gardens in Phase I North remain a traceable internal sample, not a substitute for the full corridor. Trees and canopy cover, hourly thermal conditions, ponding and drainage records, cross-season manual observations, activity calendars, repair reports, and maintenance labor hours form the inputs after field investigation; facial recognition and individual trajectories are not assumed. AI compares three combinations: lightweight facility adjustments, planting and soil improvements, and localized drainage retrofits, while showing heat exposure, use by different groups, ecological disturbance, and maintenance cost. [source:JZ-PARK-PHASE2-OPEN-20260806]
...
### Urban Patch 001: Dazhongsi Station-Street-Park Connection Lab

This iteration no longer merely describes what AI could do later. It completes one reproducible planning operation. `visual/assets/urban_patch_001.json` records the question, evidence state, three spatial prototypes, directional effect priors, six hard gates, a performance contract, a responsibility matrix, and exit conditions. The paired bilingual offline lab calculates weighted intervals and sensitivity from the same record in real time. [data:visual/assets/urban_patch_001.json#UP-001] [metric:urban_patch_count]

The prototypes have explicit spatial differences. **A Operations First** compares staffed assistance, fixed wayfinding, signal timing, and removable elements. **B At-Grade Reweave** studies a continuous ramp, crossing, opened interface, shade, and a rest point where specialist conditions permit. **C Structural Reserve** keeps an overpass or underpass only as a long-term comparison slot and removes it from the current shortlist while rail, safety, ownership, and engineering evidence is missing. The displayed plan-section is a relationship diagram, not a survey of station entrances, roads, or ownership boundaries.

The model uses only declared directional priors across four objectives: complete accessibility, public value, reversibility and stoppability, and whole-life affordability. Sliders change visible weights; they never override a hard gate. A professionally confirmed working extent, a continuous accessibility audit, station exits and construction status, disaggregated wait and conflict baselines, ownership, rail and utility conditions, and whole-life cost and maintenance responsibility are all missing. Therefore the status must remain **NO DECISION** regardless of which prototype has the highest provisional interval. AI's first valid output is not a recommended bridge or plaza, but the next evidence-acquisition list.

The performance contract turns principles into operational gates. It records complete accessible journeys for representative users, crossing wait and conflict exposure, availability of accessible and staffed service, and maintenance labor and whole-life cost. Each item states its unit, affected groups, sampling method, desired direction, harm threshold, and accountable actor. The pilot stops or rolls back if any user's route worsens, severe conflicts increase, the analogue service route fails, maintenance lacks funding, or no accountable actor signs.
...
| Beijing AI Origin Community | Universities, research, communities, and the fully open park are adjacent, but technical translation may become disconnected from daily life | Organize cross-season retesting around the approximately 9 km built public baseline, using Phase I North's 12 gardens as a traceable sample; prioritize existing ground floors over new landmarks | Test a "park operations version"; return to non-digital processes if data is unnecessary, the experience is inequitable, or the maintenance burden rises [data:geometry/public_space.geojson#PUBLIC-PILOT-02] |
| Dazhongsi AI Industry Cluster | Stations, commerce, enterprise services, and community use must jointly determine public benefit | Use Urban Patch 001 to compare operations first, at-grade reweave, and structural reserve; enterprise display must not occupy basic circulation or free places to stay | Remain at no-decision until six evidence gates are complete; suspend for pedestrian conflict, displacement, or commercial data entering public decisions [data:visual/assets/urban_patch_001.json#UP-001] |
...
![Three key areas and three AI planning loops](assets/figures/key-areas.en.png)
...
| T2 Park adaptive operations test | Priorities for shade, water adjustment, and activities across the 9 km built park | Canopy, heat, ponding, use, and maintenance, with 12 Phase I gardens as an internal sample; compare three combinations | Movable facilities, operating times, and planting, soil, or drainage tasks | Landscape, water-management, and resident determination; roll back if ecology or maintenance is overloaded |
...
![Completed park, transverse connections, and blue-green operations retesting](assets/figures/mobility-bluegreen.en.png)

## Blue-Green Space, Public Space, and Urban Character

The northern section of Phase I has already demonstrated that railway remnants, space beneath the viaduct, running, community activity, planting, geology, and children's use can coexist; the opening of Phase II extends that foundation into approximately 9 km of continuous public space. The next round does not aim to create more themed gardens. It focuses instead on **cross-season operational quality across the full corridor**: canopy cover and heat exposure, post-rain recovery, continuous accessibility, time spent by different groups, active and quiet periods, repair reporting, and maintenance labor hours jointly determine whether additions should be made. Blue-green facilities must state where water comes from, how it overflows, and who maintains them; they cannot carry the color of "ecology" only in renderings. [source:JZ-PARK-PHASE2-OPEN-20260806] [data:geometry/green_space.geojson#GREEN-REVIEW-02] [depth:blue_green_public_space]
...
This iteration uses metrics to test decision quality. The first class is the public baseline: the announced 43.6 km2, 11.4 km2, 368.4 ha and three key areas, plus the reported built park of about 9 km and 53 ha serving 70 communities and about 450,000 residents; these describe scope and service context only. The second class is proposal structure: three planning loops, ten scenario cards, six user groups, six international mechanisms, three public knowledge nodes, seven decision stages, and one auditable Urban Patch. The third class is the performance baseline that must be established in the field, including accessible detour, heat exposure, post-rain closure, public opening hours, maintenance labor, rent, and displacement risk. Predicted values are not entered. [metric:built_corridor_length_km] [metric:urban_patch_count]
...
![City Version ledger: known, pending verification, pilots, and stops](assets/figures/metrics-evidence.en.png)
...
3. China National Radio, "Phase II of the Jing-Zhang Railway Heritage Park Opens in Full," 2026-08-06; used for the opening date and reported overall scale, not as an as-built drawing or operating evaluation. [source:JZ-PARK-PHASE2-OPEN-20260806]
4. Haidian District People's Government, "Outline of the Fifteenth Five-Year Plan for National Economic and Social Development of Haidian District, Beijing," 2026-07. [source:HAIDIAN-FIFTEENTH-FIVE-YEAR-PLAN-2026]
5. Haidian District People's Government, "Beijing AI Origin Community: First Stop for Global AI Talent Innovation and Entrepreneurship," 2026-03-26. [source:AI-ORIGIN-COMMUNITY-20260324]
6. People's Daily Online Beijing, report on approval of the block-level plan for the AI innovation district along the Jing-Zhang Railway Heritage Park, 2026-08-12; background pending registry review only. [source:HD-JINGZHANG-BLOCK-PLAN-20260811]
7. Liu Dongyun, Li Baowei, Sun Miao, and Yang Ying, "Northern Section of Phase I of the Beijing Jing-Zhang Railway Heritage Park," Landscape Architecture, 2025(9): 92-97, DOI: 10.3724/j.fjyl.LA20250427, CC BY-NC-ND. [source:PHASE1-NORTH-2025]
8. Six sets of concept-proposal texts for the Jing-Zhang Railway Heritage Park connection, approximately 2020, research copies supplied by the user; used only for background comparison and not treated as current conditions or reproducible assets. [source:JZ-COMPETITION-2020]
9. Ministry of Housing and Urban-Rural Development, "Measures for Urban Design Administration" and "Measures for the Preparation and Approval of Regulatory Detailed Planning for Cities and Towns," local snapshots. [standard:MOHURD-URBAN-DESIGN-MEASURES] [standard:MOHURD-CONTROL-DETAILED-PLANNING]
10. Standing Committee of the National People's Congress, "Law of the People's Republic of China on the Construction of a Barrier-Free Environment"; and General Office of the State Council, "Implementation Plan for Effectively Addressing the Difficulties Older People Face in Using Smart Technology," local snapshots. [standard:BARRIER-FREE-ENVIRONMENT-LAW] [standard:ELDERLY-SMART-TECH-PLAN-2020-45]
11. Official websites of Vector Institute, Mila, the Alan Turing Institute, AI Singapore, Seoul AI Hub, and the AI Verify Foundation, accessed 2026-08-11; used only for mechanism comparison. See "sources.json" for details.
