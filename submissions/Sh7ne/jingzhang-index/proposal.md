...
本案面对的不是一条等待从零设计的绿廊。2025 年公开文献记载，京张高铁在学院南路至北五环之间约 6.4 km 采用地下隧道，为沿线地面空间重组提供条件；一期选取知春路至清华东路，2020—2022 年设计、2023 年建成，北段形成 12 个主题花园。文献所述桥下护栏拆除、停车空间回收、风雨跑步道、科创市集、复原铁轨及铁路材料再利用，属于已建实践，而非本案愿景。[source:PHASE1-NORTH-2025] [metric:built_phase1_garden_count]

2026 年 8 月 6 日，京张铁路遗址公园二期全线开放。公开报道给出的新基线是：西直门至北五环约 9 km、约 53 ha，联系沿线 70 个社区和约 45 万居民；南段保留恢复约 2.4 km 老铁轨。报道数据只描述总体规模，不等于竣工测绘、设施台账或服务半径模型。本案据此把工作起点从“一期北段样本”更新为“全线已经开放的公共基础设施”，将设计重心转向横向联系、跨季运营和存量界面更新。[source:JZ-PARK-PHASE2-OPEN-20260806] [metric:built_corridor_length_km] [metric:built_corridor_area_ha]
...
海淀区“十五五”规划已将北京 AI 原点社区、中关村 AI 北纬社区和百年京张 AI 创新带组织为“**两区一带**”，并提出政策设计、执行、评估、优化的闭环以及沙盒准入、退出机制。这为“城市版本”提供了正式政策语境：京张不是独立科技景观，而是连接知识策源、产业转化与真实城市问题的验证带。AI 原点社区的公开定位和八类服务用于理解创新生态，不据此推导地块和建筑方案。[source:HAIDIAN-FIFTEENTH-FIVE-YEAR-PLAN-2026] [source:AI-ORIGIN-COMMUNITY-20260324]

2026 年 8 月公开报道另称，沿线九个街区、约 1668.2 ha 的街区控规已经获批，并采用“一带一轴、两心多点”结构。由于获批文本、图则和法定控制表尚未进入仓库来源登记，本案只把这一信息作为待登记背景，不据新闻报道抄录边界、容积率、高度或地块控制。[source:HD-JINGZHANG-BLOCK-PLAN-20260811]
...
铁路曾以轨距、时刻、信号和工程责任重组区域联系。百年后的 AI 创新带，不应以更多传感器和屏幕证明先进，而应以统一的**证据基线、方案比选和后评估**组织更新。已经全线开放的京张遗址公园构成公共基线；三个重点区承担三类决策试验；每次空间干预形成可查询、可质询、可回滚的“城市版本”记录。
...
本轮需要判断的是：在约 9 km 全线开放的公园中，哪里优先增荫、调水、调座、调整时段或减少设施；一期北段 12 个主题花园作为可追溯的内部样本，而非全线替代。树木与冠幅、逐时热环境、积水与排水记录、跨季人工观察、活动日历、报修和养护工时经现场调查后构成输入，不默认使用人脸识别或个体轨迹。AI 比较轻设施调度、植物与土壤改善、局部排水改造三类组合，同时展示热暴露、不同人群使用、生态扰动和维护成本。[source:JZ-PARK-PHASE2-OPEN-20260806]
...
### Urban Patch 001：大钟寺站—街—公园横向连接实验台

本版不再只描述 AI 将来可以做什么，而完成一次可复现的规划运算。`visual/assets/urban_patch_001.json` 记录问题、证据状态、A/B/C 三个空间原型、方向性效应先验、六项硬门槛、绩效合约、责任矩阵和退出条件；双语离线实验台按同一记录即时计算加权区间和权重敏感性。[data:visual/assets/urban_patch_001.json#UP-001] [metric:urban_patch_count]

三个原型有明确空间差异：**A 运行先行**比较人工协助、固定导视、信号时段和可撤设施；**B 地面缝合**在专项条件允许时研究连续坡道、过街、界面开放与遮荫休息节点；**C 结构预留**只保留跨越或下穿的远期比较席位，在轨道、安全、权属和工程资料缺失时退出当前清单。其位置图是关系剖面，不是站口、道路或产权边界的测绘图。

模型只使用公开的方向性先验比较“完整无障碍、公共价值、可逆与可停、全周期可负担”四项目标，滑杆改变的是公开权重，不会掩盖硬门槛。当前专业确认的工作范围、连续无障碍走查、站口与施工状态、分群等待与冲突基线、权属轨道与管线条件、全周期费用与维护责任六项证据均未齐，因此不论哪一方案暂时区间较高，状态都必须保持 **NO DECISION / 不得决策**。AI 的首个有效输出不是推荐桥或推荐广场，而是一张下一步证据采集清单。

绩效合约把文字原则转为可执行 gate：记录典型使用者完整无障碍行程、过街等待与冲突暴露、无障碍与人工服务可用率、维护工时与全周期费用；每项都写明单位、受影响人群、采样方法、改善方向、伤害阈值和责任主体。任一使用者路径恶化、严重冲突增加、非数字服务失效、维护无资金承接或责任主体未签署，试点即停止或回退。
...
| 北京 AI 原点社区 | 高校、科研、社区和全线开放公园相邻，但技术转译与日常生活可能脱节 | 以约 9 km 建成公共基线组织跨季复测，一期北段 12 个主题花园作为可追溯样本；存量首层优先于新地标 | 测试“公园运行版本”；若数据并非必要、体验不公平或维护负担上升，回到非数字流程 [data:geometry/public_space.geojson#PUBLIC-PILOT-02] |
| 大钟寺 AI 产业聚集区 | 站点、商业、企业服务和社区使用需要共同判断公共收益 | 先以 Urban Patch 001 比较运行先行、地面缝合和结构预留；企业展示不得侵占基本通行和免费停留 | 六项证据门槛未齐保持不决策；人流冲突、排挤或商业数据混入公共决定即暂停 [data:visual/assets/urban_patch_001.json#UP-001] |
...
| T2 公园适应性运行测试 | 9 km 建成公园的增荫、调水和活动优先级 | 树冠、热、积水、使用、维护；以一期 12 花园为内部样本比较三类组合 | 移动设施、时段、植物土壤或排水任务 | 景观、水务、居民裁决；生态或维护超载即回滚 |
...
一期北段已经证明，铁路遗存、桥下空间、跑步、社区活动、植物、地质和儿童使用可以共存；二期开放又把这一基础延伸为约 9 km 连续公共空间。下一轮不以再造主题花园为目标，而以**全线跨季运行质量**为重点：树冠与热暴露、雨后恢复、无障碍连续、不同人群停留、活动与安静时段、报修和维护工时共同决定是否增建。蓝绿设施必须说明水从哪里来、如何溢流、谁维护，不能只在效果图中承担“生态”颜色。[source:JZ-PARK-PHASE2-OPEN-20260806] [data:geometry/green_space.geojson#GREEN-REVIEW-02] [depth:blue_green_public_space]
...
本版用指标检验决策质量。第一类为公开基线：公告约 43.6 km²、11.4 km²、368.4 ha 和三处重点区，以及报道所载建成公园约 9 km、约 53 ha、70 个社区和约 45 万人，只用于说明任务与服务背景；第二类为方案结构：3 套规划闭环、10 张场景卡、6 类使用者、6 个国际机构与项目、3 个公共知识节点、7 个决策阶段和 1 项可审计 Urban Patch；第三类为必须现场建立的绩效基线，包括无障碍绕行、热暴露、雨后关闭、公共开放时数、维护工时、租金与搬迁风险，不能填写预测值。[metric:built_corridor_length_km] [metric:urban_patch_count]
...
3. 央广网：《京张铁路遗址公园二期全线开放》，2026-08-06；用于核对开放日期和报道所载总体规模，不作为竣工图或运营评估。[source:JZ-PARK-PHASE2-OPEN-20260806]
4. 北京市海淀区人民政府：《北京市海淀区国民经济和社会发展第十五个五年规划纲要》，2026-07。[source:HAIDIAN-FIFTEENTH-FIVE-YEAR-PLAN-2026]
5. 北京市海淀区人民政府：《北京 AI 原点社区：全球 AI 人才创新创业第一站》，2026-03-26。[source:AI-ORIGIN-COMMUNITY-20260324]
6. 人民网北京频道：《海淀京张铁路遗址公园沿线人工智能创新街区重点地区街区控规获批》，2026-08-12；仅作待登记背景。[source:HD-JINGZHANG-BLOCK-PLAN-20260811]
7. 刘东云、李保炜、孙淼、杨颖：《北京京张铁路遗址公园一期工程北段》，《风景园林》2025(9): 92—97，DOI: 10.3724/j.fjyl.LA20250427，CC BY-NC-ND。[source:PHASE1-NORTH-2025]
8. 京张铁路遗址公园贯通概念方案征集六组文本，约 2020 年，用户提供研究副本；仅作背景比较，不视为当前现状或可复制资产。[source:JZ-COMPETITION-2020]
9. 住房和城乡建设部：《城市设计管理办法》及《城市、镇控制性详细规划编制审批办法》本地快照。[standard:MOHURD-URBAN-DESIGN-MEASURES] [standard:MOHURD-CONTROL-DETAILED-PLANNING]
10. 全国人大常委会：《中华人民共和国无障碍环境建设法》；国务院办公厅《关于切实解决老年人运用智能技术困难的实施方案》本地快照。[standard:BARRIER-FREE-ENVIRONMENT-LAW] [standard:ELDERLY-SMART-TECH-PLAN-2020-45]
11. Vector Institute、Mila、Alan Turing Institute、AI Singapore、Seoul AI Hub、AI Verify Foundation 官方网站，访问日期 2026-08-11；只用于机制比较，详见 `sources.json`。
