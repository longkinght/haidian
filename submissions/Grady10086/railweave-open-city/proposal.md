...
license: "CC-BY-4.0"
summary: "方案坚持城市织体先行、智能应用有序织入，以百年京张公共空间和普通服务为经，以三条区域协同廊道为纬，把AI作为可准入、可暂停、可解编的技术线程；由AI原点组织问题、众智园独立验证、大钟寺稳妥转化，并以一处共享首层开展百日限定验证。"
tracks: ["ai-traffic-walkability", "enterprise-services-ecosystem", "civic-agent-governance"]
iteration: "2026.08.19"
---
...
| 实施准备 | 一处共享首层、一个公共服务场景、百日限定验证；六个工作环节、六类成本包、全过程验收 | 场地权利、责任主体、工程量、报价和参与授权 |
| 公共价值 | 普通服务不断线，无账号、可拒绝、可申诉、可恢复 | 六类使用群体同任务走查和现场基线 |

### 首期行动建议：一处共享首层、一个公共服务场景、百日限定验证

首期不同时启动三处工程，而是在 AI 原点选择一处经权利核验的共享首层候选界面，围绕一条约 100—150 米服务路线、3—5 个信息决策点和一个 1:1 无障碍服务湾，开展“普通服务 + 可逆 AI 辅助”限定验证。验证重点不是技术演示，而是同一名使用者在不注册账号、断网或拒绝 AI 时，能否不增加费用、不产生不合理等待和异地行程地完成同一事项。

百日工作安排、六类成本包和全过程验收要求只在后文“首期百日限定验证”完整呈现一次。本次成果已形成实施准备建议；现场启动前，由有权主体依法确认场地、权属、责任、专业条件、报价和参与授权，后台模拟测试不替代现场调查与法定程序。[data:visual/assets/readiness_decision_receipt.json]
...
**现状基础与工作重点。** 根据官方信息，AI 原点是以五道口为核心、整合多个载体并向周边辐射的约 3 km² 分布式创新网络，已具备企业服务、人才服务和人机协同服务窗口等实践基础。[source:AI-ORIGIN-2026] [source:AI-ORIGIN-TALENT-STATION] `KEY-002` 仅表达工作范围，不代表法定边界。[data:geometry/key_areas.geojson#KEY-002]
...
为避免三项重点项目同时铺开，本方案建议在完成场地与启动条件核验后，优先把 AI 原点一处共享首层候选界面作为“开源修补街”100 日限定样布。样布只占用经核验的一条约100至150米决策路线、有限前廊和受控后室，设置3至5个待实测确认的决策点和一个1:1无障碍服务湾。前廊保持连续通行，设置固定与触觉导向、纸质问题卡、需求门诊、开放零件墙、人工转介台和公开回执；后室仅处理经授权的材料、版本和复核工作。AI 只提供建议，不替代人工受理、例外判断、申诉和停止决定。路线长度、点位、权属、开放时段、消防和可达性均为设计控制包，待现场与专业核验，不作为已落实事实。[data:geometry/public_space.geojson#DC-AI-001]
