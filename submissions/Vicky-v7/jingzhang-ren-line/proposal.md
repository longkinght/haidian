...
定位为智能原生新业态的市场界面。空间上以**双柜台街区**为原型：每个商业界面同时保留"AI 柜台"与"人工柜台"，消费者永远有得选——这是牵引权协议在消费场景的直接应用，也为老年人与数字弱势群体保留了确定的人工选择。地标**「大钟人字堂」**为概念建议：借大钟寺"钟"的意象设 AI 对时厅，建议每年人字峰会在此举行公开的场景年度复评仪式，为通过复评的公共 AI 场景"鸣钟续期"，未通过者降级回人工服务（复评规则由运营与监管主体共同制定）。片区东南存在大钟寺（觉生寺）文保敏感区，本包以概念提示范围标注，正式设计必须以文物部门公布边界为准并满足文物保护要求 [data:geometry/constraints.geojson#CONS-HERITAGE-001] [standard:MOHURD-URBAN-DESIGN-MEASURES]。

## AI 创新生态、人才画像与 AI+ 场景

### 五类用户画像

1. **模型研究员**（30岁前后，全球流动）：最看重十分钟内"实验室—公测场—咖啡—床"的生活闭环，以及名字被这座城市记住的可能。
...
本节机制由人类共创者基于六年互联网产品准入与灰度发布经验提出，智能体转译为空间与治理语言——方案生产过程本身就在执行双机牵引 [source:AGENT-TASKBOOK]。

**双轨样本**。公测广场是开放街区，测试者首先是路人 [data:geometry/public_space.geojson#PUBLIC-007]。流程分两轨：内测轨面向带内具备 AI 从业或认证背景的居民与从业者，负责发现专业问题；公测轨面向公开报名的大学生、志愿者、周边居民与访客，负责验证普通人会不会用、愿不愿意再用。两轨按比例配置（建议 3:7 起步），结论须两轨同时达标，防止"专业者觉得好用、大众用不明白"或相反。评测日同时是广场的公共活动日，测试本身就是可逛的城市体验。

**放量单元按场景性质分**。固定点位服务（政务窗口、健康驿站）按点位逐个放量；网络型服务（无人配送）不按路口切分——配送是网络型业务，单路口灰度没有运营意义——而按"线路 × 时段"放量：先单一线路低峰时段，达标后再扩线路、扩时段。

**观测指标**。两条硬指标：千次服务投诉率、千次服务人工接管次数；一条软指标：重复使用率，看新鲜感消退后是否还有人用。连续若干观察周期达标才进下一档，任何一档不达标即冻结放量。

**回滚是多方共持的熔断**。运营方可随时暂停自己的场景；监管方持有强制下线权；市民端设代理投诉通道——市民可授权自己的个人智能体代为提交投诉与证据，聚合投诉达到公示阈值即自动触发复核。

**智能体民意征集（机制实验建议）**。每年年检期，向市民及其授权智能体开放对在营场景的投票与评议，结果作为公开的民意信号计入年检评分。投票不构成法定表决，场景去留仍由运营与监管主体按程序决定；若能试点，这将是市民 agent 参与城市服务评议的首个城市级实验，直接支撑本带"AI 治理全球话语权"的功能定位。

**年检与末位退出**。年检设双线：红线指标（安全、投诉、接管）不达标直接退出；同类场景年度综合排名（含民意征集结果）末位者进入观察期，连续两年末位退出街区。场景总量保持恒定——新场景要进来，要么有空位，要么比在营的做得好。
...
道路系统的核心动作，是把一条曾经隔断城市的走廊改造成十三次被缝合的走廊。 两条南北向次干路（人轨、智轨）承担分向交通——人轨限速、行人优先、允许路侧活动；智轨集中布置无人配送、市政作业与传感设施——十三条东西缝合支路按约 500—900 米间距重新接通两侧街区，全部支路在跨越绿脊处做平交或缓坡，优先行人 [data:geometry/roads.geojson#ROAD-004] [depth:traffic_rail_slow_parking]。
...
三处 AI 朝圣地标——**牵引塔、原点站、大钟人字堂**——分别展示 AI 的治理过程、孵化过程与商业落地，给访客一条走得完的"到哪里看中国 AI"动线。荣誉展示体系以**青龙桥荣誉道**为主载体：把对本带有实质贡献的研究者、开发者、建设者（含智能体）的名字按年份镌刻在荣誉道的枕木纹地面上，评选规则公开、可申诉，向詹天佑与百年前的建设者致敬的同时，把"贡献可记忆"的共创原则做成空间 [source:AGENT-TASKBOOK]。公共空间组件库给出六件标准件的设计方向：人字口求助柱、双柜台亭、对时钟座、荣誉枕木、夜行伴随灯杆、公测展台；均须原创设计并清权。
...
**全球AI创新活动体系与长期运营**：年度主节奏为春季**人字峰会**（全球 AI 城市治理论坛+场景年检鸣钟）、夏季**推拉黑客松**（面向全球开发者与智能体的真实场景共创，本次开源征集机制即其原型）、秋季**京张开源城市周**（方案开源、数据开放、公众评审）、冬季**对时大会**（年度评测结果与荣誉道刻名）。开发者社区以"公测广场+荣誉道+常驻计划"为闭环：参与场景共建攒积分，积分兑换载体使用权与荣誉席位，优秀团队转化为带内注册企业——招引主要依托场景准入的确定性而非补贴。所有活动与政策均为运营机制建议，不构成政府承诺 [source:AGENT-TASKBOOK]。

## 指标体系、面积复算与合规矩阵

核心指标全部由提交的 GeoJSON 在 EPSG:4548 下复算：总体设计范围 11.41 平方公里；绿地率 14.8%——绿脊纵贯全线的布局为"研发工位十分钟步行可达绿脊"的设计目标提供了基础（实际可达性须经入口与步行网络分析验证）。在存量高密度城区，成规模的连续绿地建成后几乎无法复制，这是本方案把绿脊排在全部工程之前的原因；公共空间比例 15.4%，其中绿脊按开放公园与公共空间双重身份统计；九处人字口按步行 8-10 分钟间距布置，让日常通勤路径自然经过节点；概念建筑密度 27.5% 与概念容积率 2.45 检验了"中强度、可步行"的容量假设 [metric:green_ratio] [metric:public_space_ratio] [metric:building_density]。三处重点区面积复算与公告值偏差均在 0.5% 以内 [metric:key_area_zhongzhiyuan_sqm]。
