...
### 3.5 Task Book Closed-Loop Matrix: Three Positions — Five Functions — Three Zones & Two Wings

This matrix maps the official task book's three positions, five functions, and three zones & two wings to this proposal's spatial locations and core scenarios, demonstrating that the proposal is not a separate invention but a spatial answer grown within the task book framework. All spatial locations are conceptual suggestions for professional teams to develop further.

| Three Zones & Two Wings (Task Book) | Corresponding Three Positions | Corresponding Five Functions | This Proposal's Spatial Location | Core Scenarios / Nodes | Conceptual Note |
|-------------------------------------|-------------------------------|------------------------------|----------------------------------|------------------------|-----------------|
| **AI Origin Community** (World-class AI innovation ecosystem) | AI Integration Innovation Belt, Urban AI Living Experience Belt | World-class AI innovation ecosystem, AI+ Scenario Empowerment Paradigm | Middle · Gathering Segment (Zhichunlu—Qinghua East Rd, ~104.3 ha) | Grass Theater Co-performance, Subway Heartbeat Point, University Inspiration Corner | The middle segment is the park's most open area, closest to Line 13, and adjacent to universities — the origin where AI innovation ecosystem moves from lab to public space. The Grass Theater lets people gather spontaneously; the Heartbeat Point turns subway frequency into perceptible urban pulse; the Inspiration Corner gives developers and students a semi-outdoor exchange space. Conceptual suggestion. |
| **Zhongzhiyuan AI Autonomous Innovation Acceleration Zone** (AI full-stack autonomous innovation system & global AI governance voice) | AI Integration Innovation Belt, Century-old Jing-Zhang Cultural Belt | AI full-stack autonomous innovation system, Global AI governance voice, Intelligent AI Vitality City | North · Flow Segment (Qinghua East Rd—North 5th Ring Jianting Bridge, ~192.9 ha) | Pillar Light Cascade, Mist-Light Corridor, Children's Field (preserved & upgraded), Qinghe Wind Corridor | The north segment is narrow and linear — not a gathering field but a flowing line. Pillar Light Cascade transforms the most mundane bridge pillars into a timeline from steam locomotives to high-speed EMUs, the architectural-scale expression of "from autonomous design to autonomous intelligence." Children's field protects children; mist and light corridor provide passage and illumination. Conceptual suggestion. |
| **Dazhongsi AI Industry Cluster** (Intelligent-native new business formats) | Urban AI Living Experience Belt, Century-old Jing-Zhang Cultural Belt | AI+ Scenario Empowerment Paradigm, Intelligent AI Vitality City | South · Home Segment (Beijing North Station—Zhichunlu, ~72.0 ha) | Old Track Memory Segment, Breathing Gate, Home Plaza, Life Service Corner | The south segment borders residential areas — it is "home." AI exists in the lowest-key way: breathing glow, quiet wayfinding, convenient services. The old track path is most completely restored in the south segment, a cultural anchor that people can step on, walk on, stop at, and listen to. Residents have veto power. Conceptual suggestion. |
| **Zhongguancun Tech Service Wing** (Global factor allocation, Zhongguancun IP & capital empowerment) | AI Integration Innovation Belt | AI full-stack autonomous innovation system, World-class AI innovation ecosystem | Middle segment辐射 area (Wudaokou—University belt, conceptual collaboration) | University Inspiration Corner, Developer Demo Corner, Community Movie Night | Zhongguancun Tech Service Wing's factors (talent, capital, IP) flow into the park through the middle segment's University Inspiration Corner and Developer Demo Corner. The proposal does not fabricate enterprise lists or investment amounts — it only provides spatial carrying mechanisms: power, WiFi, whiteboard walls, bookable Grass Theater. Conceptual suggestion; specific industry collaboration awaits professional development. |
| **Xiaoyue River Scenario Empowerment Wing** (AI scenario empowerment & intelligent AI vitality city) | Urban AI Living Experience Belt | AI+ Scenario Empowerment Paradigm, Intelligent AI Vitality City | South–Middle gap stitching zone (near Zhichunlu, conceptual collaboration) | South–Middle Sidewalk Wayfinding, Pulse Morning-Run Lighting | The core of Xiaoyue River Scenario Empowerment Wing is "AI scenarios that are perceptible and experienceable." The proposal stitches the gap between south and middle segments (cut by buildings) through sidewalk wayfinding markings, making people willing to walk from home to the stage. Pulse morning-run lighting turns the 9km green corridor into an experienceable AI scenario. Conceptual suggestion. |

> **Three Positions Coverage**: Century-old Jing-Zhang Cultural Belt → Old Track Memory Segment, Pillar Light Cascade vehicle evolution, Jing-Zhang Ring; Urban AI Living Experience Belt → Breathing Gate, Home Plaza, Children's Field, Pulse Morning Run; AI Integration Innovation Belt → Grass Theater, Heartbeat Point, University Inspiration Corner, Pillar Light Cascade.
>
> **Five Functions Coverage**: AI Full-Stack Autonomous Innovation System → Zhongzhiyuan north segment + Pillar Light Cascade timeline; World-class AI Innovation Ecosystem → AI Origin Community middle segment + Grass Theater; AI+ Scenario Empowerment Paradigm → Xiaoyue River Wing + 15 scenario cards; Intelligent AI Vitality City → Dazhongsi south segment + convenient AI services; Global AI Governance Voice → data anonymization, resident veto power, human review mechanisms (see scenario card AI matrix).
>
> Note: The above correspondences are conceptual suggestions. The precise spatial scope of the three zones and two wings is subject to official boundary surveys and regulatory plans. This proposal does not fabricate industry data, investment amounts, or enterprise lists.


### 3.6 Regional Innovation Collaboration Diagram & Interface Description

This proposal's regional collaboration does not fabricate industry data or investment amounts. Instead, it explains what interfaces Jing-Zhang Pulse — as a public space spine — can provide to surrounding innovation nodes, and what support it can receive. All interfaces are conceptual proposals awaiting professional development; relationships without formal basis are marked "collaboration concept / pending verification."

![Jing-Zhang Pulse · Regional Innovation Collaboration](assets/figures/regional-collaboration.en.png)

**Regional Collaboration Interface Description (Conceptual / Pending Verification):**

| Collaboration Node | Spatial Relationship | Interface Type | Jing-Zhang Pulse Can Provide | Jing-Zhang Pulse Can Receive | Status |
|-------------------|---------------------|---------------|-------------------------------|-------------------------------|--------|
| **Beiwei Community** | Same district (Haidian), spatially adjacent (exact location pending verification) | Talent · Scenarios | Public event space, community display window, AI scenario testing field | Community resident users, daily scenario data (anonymous) | Concept / Pending |
| **Future Science City** | Northern Beijing, Changping District, ~15-20km from Jing-Zhang (conceptual distance) | Tech · Talent | Technology display & public experience space, developer exchange venue | Cutting-edge tech outcomes, research talent, testing equipment | Concept / Pending |
| **Huairou Science City** | NE Beijing, Huairou District, ~50-60km (conceptual distance) | Compute · Basic Research | Science display & public understanding window | Large scientific facility compute resources, basic research outcomes (conceptual interface) | Concept / Pending |
| **E-Town (BDA)** | Southern Beijing, Daxing/Yizhuang, ~25-30km (conceptual distance) | Industry · Scenarios | Innovation product launch experience space, consumer feedback field | Industrialization resources, smart manufacturing scenarios, enterprise collaboration | Concept / Pending |
| **Jing-Jin-Ji Region** | Regional level, Jing-Zhang as a northern Beijing node | Capital · Market | International communication window, city brand display | Regional capital, cross-city markets, policy collaboration (conceptual interface) | Concept / Pending |

> **Collaboration Principle**: Jing-Zhang Pulse does not compete with surrounding innovation nodes for functional positioning. Instead, it serves as a "perceptible, experienceable, communicable" public space spine — providing technology with a public-facing display window, and communities with daily access to innovation. All collaboration relationships are conceptual proposals and do not constitute cooperation commitments or policy arrangements. Specific distances, interface mechanisms, and cooperation models await professional teams and relevant parties to develop further.
...
**Green space definition note (three nested concepts, not contradictory):**
- **Park green space (G1/1401):** Land-use code 1401 park green space, ~212.5 ha, 18.6% of site. This is the national land-use classification category.
- **Green spine (Pulse Green Corridor):** The linear green public space running north-south along the Jing-Zhang railway heritage, ~228.8 ha, including park green space plus adjacent protective green belts and roadside greenery. It is the ecological backbone of the proposal.
- **Total green space (green_space.geojson):** Sum of all green space in the geometry layer, ~338.7 ha ([metric:green_space_area_sqm]), 29.68% of site ([metric:green_ratio]), including park green space, protective green space, plaza green space, and attached green space.
The three are nested: Park green space ⊂ Green spine ⊂ Total green space. All areas are calculated based on provisional boundaries and will be recalculated when official survey data is released.
...
### 6.1.1 AI Innovation Ecosystem Map & Scenario-Space-Operations-Data-Human Review Matrix

This map maps the eight elements required by the task book (land/space, industry, capital, talent, compute, data, scenarios, testing/human review) to the three zones and two wings, clarifying core carrying and conceptual support for each area. All element levels are conceptual judgments — no enterprise lists, investment amounts, or output values are fabricated. Pending professional development.

![Jing-Zhang Pulse · AI Innovation Ecosystem Map](assets/figures/ai-ecosystem-map.en.png)

**Scenario-Space-Operations-Data-Human Review Matrix (Conceptual):**

| Card | Spatial Location | Operations | Data Strategy | Human Review | Source Level |
|------|----------------|------------|---------------|--------------|--------------|
| 01 Heartbeat Train | Middle · Subway Heartbeat Point | Park operator daily maintenance, equipment vendor tech support | Real-time train state only, no history, no personal data | Metro operator safety review | Conceptual / Pending approval |
| 02 Grass Theater | Middle · Sunken Lawn | Community ops team manages bookings, universities/developers/community self-organize | Booking data 30 days, density data not stored | Community ops team reviews event content | Conceptual / Pending approval |
| 03 Old Track Whisper | South · Old Track Memory Segment | Park operator maintains equipment, cultural advisor updates content | No user data collected | Historian reviews content accuracy | Conceptual / Pending approval |
| 04 Breathing Gate | South · South Entrance | Park operator daily maintenance | No data collection | No human review needed | Conceptual |
| 05 Mist-Light River | North · Mist-Light Corridor | Park operator + equipment vendor maintenance | Environmental data only (temp/humidity), no personal data | Parks department reviews water safety | Conceptual / Pending approval |
| 06 Children's Sound Painting | North · Children's Field | Park operator maintains, child psychology expert guides | No audio or images stored | Child psychology expert reviews interaction safety | Conceptual / Pending approval |
| 07 Developer Demo Corner | Middle · University Inspiration Corner | University + community joint operations | No AI data collection | Community ops team manages space use | Conceptual |
| 08 Qinghe Wind Whisper | North end · Qinghe Wind Corridor | Park operator + equipment vendor maintenance | Wind speed data only | Municipal department reviews device safety | Conceptual / Pending approval |
| 09 Community Movie Night | Middle · Grass Theater | Community committee curates, volunteers execute | No AI data collection | Community committee reviews film content | Conceptual |
| 10 Pulse Morning Run | Full route · Slow-traffic system | Park operator maintenance | Anonymous counting, no personal data | No human review needed | Conceptual |
| 11 AI-Generated Railway Stories | South/Middle · Narration System | Content team maintains, historian reviews | No user data collected | Historian reviews factual accuracy | Conceptual / Pending approval |
| 12 Pulse Data Wall | Middle · Data Display | Park operator + data team maintenance | Aggregated data 90 days, raw data not stored | Data governance team reviews privacy compliance | Conceptual / Pending approval |
| 13 Pillar Light Cascade | North · Under Elevated Bridge | Park operator + content team + equipment vendor maintenance | No data stored | Metro operator + heritage authority reviews content & safety | Conceptual / Pending approval |

> **Human Fallback Principle**: All AI scenarios include human review. Content generation (Cards 03, 11) requires historian review; safety-related (01, 05, 08, 13) requires relevant department approval; privacy-related (02, 12) requires data governance review; child-related (06) requires child psychology expert guidance. When AI fails, all scenarios degrade to non-AI mode without affecting basic park use.
...
4. **International visitors:** Recognition, check-in, outreach. Need identifiable landmarks, tellable stories, photographable scenes. The marker tower and heartbeat point are outreach points.
...
### 6.2.1 Inclusive Service Matrix (Conceptual Suggestion)

This matrix maps six inclusive user types to specific nodes, services, non-digital alternatives, and human assistance channels, ensuring Jing-Zhang Pulse does not exclude any user. All services are conceptual suggestions for professional teams to develop further.

| User Type | Corresponding Node | Services | Non-Digital Alternative | Human Assistance |
|-----------|-------------------|----------|------------------------|-----------------|
| **Wheelchair / Mobility Impaired** | Full-route slow-traffic, Grass Theater, Home Plaza | Accessible continuous ramps, wheelchair-accessible rest platforms, low-height service counters, accessible restrooms | Paper accessible route maps, on-site staff guidance | Park operator accessible service hotline, call buttons at key nodes |
| **Visually Impaired** | Old Track Memory Segment, Heartbeat Point, wayfinding routes | Tactile paving (tactile guidance at old track edges), voice narration posts, audible sound-light landmarks | On-site staff one-on-one tours, Braille signage | Human service button at narration posts, community volunteer regular companion walks |
| **Hearing Impaired** | Grass Theater, Community Movie Night, narration system | Visual subtitle screens, light rhythm replaces sound cues, sign language video tours (scan QR to view) | Paper illustrated guides, on-site sign language volunteers | Sign language volunteers during event hours, text communication boards at service desks |
| **Elderly** | South Home Plaza, Breathing Gate, Old Track Path | Increased seating density, quiet environmental monitoring screens (large text), convenience service corner, slow-paced tours | Paper large-print guides, regular community staff visits | Convenience service station in south segment, volunteers assist with smart devices |
| **Child Caregivers** | North Children's Field, South Home Plaza, Grass Theater | Parent rest area next to children's field, nursing room, child safety fencing, family restroom | On-site staff childcare assistance, paper children's activity guides | Safety officers during children's activity hours, lost child assistance at service desk |
| **Non-Smartphone Users** | All route nodes, narration system, event booking | Physical wayfinding signage, on-site human consultation desk, phone booking channel, paper event calendar | All services available on-site or by phone, no phone dependency | Human service point at each major node, operator service hotline |

> **Inclusivity Principle**: All AI services at Jing-Zhang Pulse have non-digital alternatives and human assistance channels, excluding no user. AI enhances human capability, it does not replace human service. Professional accessibility teams must develop accessible continuous routes, Braille signage, sign language services, and other specialized content.
...
- AI role: Transient anonymous counting of running rhythm (no personal identity or historical data stored); lights shift color with pace (south warm white → middle amber → north cool blue)
...
### 6.3.1 Scenario Card AI Boundary and Data Governance Matrix (Conceptual)

This matrix provides conceptual-level clarification of AI usage boundaries, input data, retention policies, human review, and failure fallback for all 15 scenario cards. All AI functions are conceptual suggestions requiring professional development and field testing before implementation. Data collection must comply with China's Personal Information Protection Law (PIPL), defaulting to anonymization without personally identifiable information.

| Card | AI / Non-AI Boundary | Input Data | Data Retention | Model / Rules | Human Review | Failure Fallback | Test Metrics | Deactivation |
|------|----------------------|------------|----------------|---------------|--------------|------------------|--------------|--------------|
| 01 Heartbeat Train | AI only for train detection & light sync, no crowd recognition | Line 13 train approach signal (non-contact vibration/acoustic sensors) | Real-time state only, no history | Rule engine: approach→fade in→follow→afterglow | Metro operator safety review | Sensor failure → constant low brightness | Train detection ≥95%, light delay <200ms | Resident complaints / metro request / after 21:30 |
| 02 Grass Theater | AI only for lighting atmosphere & event booking, no content generation | Crowd density (anonymous IR counting), booking platform data | Booking data 30 days, density not stored | Rules: high density→stage lights up, booking→reserved slot | Community operations team reviews events | System failure → manual lighting control | Booking usage rate, resident satisfaction | Event content violation / complaints / winter |
| 03 Old Track Whisper | AI generates ambient soundscapes, narration is pre-recorded | No real-time data input | No user data collected | Pre-recorded soundscape + scheduled playback, no real-time generation | Cultural advisor reviews historical accuracy | Device failure → silence, no impact on path | Narration accuracy, visitor dwell time | Cultural heritage authority request / device damage |
| 04 Breathing Gate | AI only for breathing rhythm lighting, no sensing, no data | No input (fixed 4s on/off rhythm) | No data | Fixed rule: 4s breathing cycle | No human review needed | Light failure → off, no impact on access | Fixture uptime ≥95%, resident acceptance | Resident complaints / fixture damage |
| 05 Mist-Light River | AI only for environmental response (temp/humidity triggers mist), no crowd recognition | Temperature/humidity sensor data | Environmental data only, no personal data | Rules: temp>28°C & humidity<60% → mist on | Parks department reviews water safety | Sensor failure → mist off, lights only | Water efficiency, visitor satisfaction | Drought period / parks department request / winter |
| 06 Children's Sound Painting Wall | AI converts sound to visual, no voice content captured | Sound frequency/loudness (no voice content stored) | No audio or images stored | Rules: frequency→color, loudness→line thickness | Child psychology expert reviews interaction safety | Device failure → static painting wall | Child engagement duration, parent satisfaction ≥85% | Parent complaints / volume exceeds limits / device damage |
| 07 Developer Demo Corner | No AI, pure physical space + power + WiFi | No AI input | No AI data | Non-AI scenario | Community operations manages space use | N/A | Space usage rate, event count | Space renovation / operations adjustment |
| 08 Qinghe Wind Whisper | AI only for wind-to-sound-light conversion, no crowd recognition | Wind speed sensor data | Environmental data only | Rules: wind speed→light flow speed + wind chime volume | Municipal department reviews device safety | Sensor failure → constant soft light | Device uptime, visitor dwell time | High wind warning / municipal request / winter |
| 09 Community Movie Night | No AI, purely human-curated community event | No AI input | No AI data | Non-AI scenario | Community committee reviews film content | N/A | Event attendance, resident satisfaction | Content violation / resident complaints |
| 10 Pulse Morning Run | AI only for running-rhythm light sync, no runner identity | Floor pressure sensors (anonymous counting) | No personal data | Rules: running rhythm→light pulse frequency | No human review needed | Sensor failure → constant light | Runner usage rate, light sync accuracy | Resident complaints / device damage |
| 11 AI-Generated Railway Stories | AI generates narrative content, must be human-reviewed before publishing | Jing-Zhang railway historical materials (public literature) | No user data collected | LLM generation + human review | Historian reviews factual accuracy | Content questionable → switch to pre-recorded narration | Content accuracy, visitor satisfaction | Factual errors / cultural heritage authority request |
| 12 Pulse Data Wall | AI only for anonymous aggregated data display, no personal info | Park footfall (anonymous IR counting), environmental data | Aggregated data 90 days, raw data not stored | Rules: real-time aggregation → visualization | Data governance team reviews privacy compliance | Data anomaly → "updating" display | Data delay <5min, privacy compliance 100% | Privacy complaints / data quality issues |
| 13 Pillar Light Cascade | AI only for train-triggered projection sync, content is pre-recorded | Train approach signal (non-contact sensors) | No data stored | Rules: train approach → sequential pillar projection → afterglow | Metro operator + cultural heritage reviews content & safety | Sensor failure → projection off, no impact on under-bridge access | Train detection ≥95%, projection sync delay <500ms | Metro operator request / after 21:30 / resident complaints / content review failure |

> Note: All AI functions above are conceptual suggestions. Specific technical solutions, data compliance, and safety measures must be developed by professional teams and approved by relevant authorities before implementation. Scenarios involving personal information must complete a Personal Information Protection Impact Assessment (PIA).


**Scenario Card 14: AI Borderless Retail Experience Station**
- Location: South · Dazhongsi AI Industry Cluster (near Dazhongsi metro station, conceptual location)
- Target users: Local residents, office workers, tech consumers, international visitors
- Behavior: AI virtual try-on, personalized product recommendations, frictionless payment, scan-and-ship shopping
- Character: Intelligent-native, unobtrusive, like a shop window that can talk
- AI Role: Anonymous browsing preference-based recommendations (no personal identity), real-time image processing for virtual try-on, NFC-based frictionless payment
- Non-AI Boundary: Product display, checkout, after-sales service retain human channels; AI recommendations can be turned off with one click
- Data Strategy: No personal identity stored, only anonymous aggregated preferences; try-on images processed in real-time without retention
- Human Review: Operations team reviews recommendation content daily; consumers can provide feedback on inappropriate recommendations
- Failure Fallback: AI failure → ordinary retail store, manual checkout, paper product descriptions
- Test Metrics: Recommendation accuracy ≥80%, consumer satisfaction ≥75%, virtual try-on response <3s
- Deactivation: Consumer complaints exceed threshold / data compliance issues / operator exits / AI recommendation accuracy consistently below 60%
- Conceptual suggestion, for professional teams to develop further

**Scenario Card 15: Smart Business Service Pod**
- Location: South · Dazhongsi AI Industry Cluster (business service node near metro entrance, conceptual location)
- Target users: Business travelers, remote workers, startup teams, meeting participants
- Behavior: AI real-time translation (CN/EN), smart meeting minutes, automatic document formatting, virtual office booking, one-stop business travel services
- Character: Quiet, efficient, like a personal secretary
- AI Role: Speech-to-text + auto summarization, multilingual real-time translation, intelligent document formatting, booking scheduling
- Non-AI Boundary: Meeting rooms, printing, coffee and other basic services retain human staff; AI translation is for reference only, important documents require human verification
- Data Strategy: Users can choose not to record meeting content; translation data not retained; documents automatically deleted after processing
- Human Review: Business service team reviews AI-generated minutes and translations; users can request human review
- Failure Fallback: AI failure → ordinary business center, human translation service, paper records
- Test Metrics: Translation accuracy ≥85%, meeting minutes completeness ≥80%, user satisfaction ≥75%
- Deactivation: User complaints exceed threshold / data compliance issues / operator exits / translation accuracy consistently below 70%
- Conceptual suggestion, for professional teams to develop further
...
1. **Heartbeat Point (middle)** — the ritual of "waiting for a train." Line 13 trains arrive as a metronome; lights brighten, follow, and retain warmth with each train. It needs no photo-prop installation — the experience is standing there and waiting. It is the "heartbeat itself" of the entire pulse.
...
| P-15 | AI Borderless Retail Experience Station | South · Dazhongsi | Intelligent-native retail | Phase 2 |
| P-16 | Smart Business Service Pod | South · Dazhongsi | Intelligent-native business | Phase 2 |
...
### 10.1.1 P-01—P-16 Conceptual Implementation Matrix

This matrix provides conceptual-level clarification of participating entities, currently actionable items, approval/validation triggers, cost tiers, operations responsibility, KPIs, and exit conditions for all 14 renewal projects. All content is conceptual suggestion and does not constitute implementation commitment or scheduling.

| ID | Project | Participating Entity Types | Currently Actionable | Approval / Validation Triggers | Cost Tier | Operations Responsibility | Success KPIs | Pause / Exit Conditions |
|----|---------|---------------------------|---------------------|-------------------------------|-----------|--------------------------|--------------|------------------------|
| P-01 | Subway Sound-Light · Heartbeat Point | Designer + Metro Operator + Parks Dept | Concept design, sensor selection testing, non-contact sensing prototype | Prototype phase requires metro operator safety permit and parks dept land use consent | Medium | Park operator + equipment vendor | Train detection ≥95%, resident satisfaction ≥80% | Metro operator deactivation / complaints exceed threshold / equipment aging |
| P-02 | Grass Theater · Co-performance Field | Designer + Community + Universities | Concept design, lawn terrain assessment, event booking platform prototype | Construction requires parks dept lawn renovation permit and community consultation | Low-Medium | Community operations team | Monthly events ≥4, resident satisfaction ≥80% | Event content violation / lawn degradation / resident complaints |
| P-03 | Old Track Whisper Audio System | Designer + Cultural Advisor + Heritage Authority | Concept design, narration content writing, audio post selection | Content release requires historian review; installation requires heritage authority consent | Low | Park operator + content maintenance team | Narration accuracy 100%, visitor usage ≥30% | Content inaccuracy / heritage authority request / equipment damage |
| P-04 | Breathing Gate (South Entrance) | Designer + Resident Representatives + Parks Dept | Concept design, fixture selection, resident consultation | Installation requires resident consent and parks dept permit | Low | Park operator | Resident acceptance ≥80%, fixture uptime ≥95% | Resident complaints / fixture damage / safety hazards |
| P-05 | Children's Field Light/Sound Upgrade | Designer + Child Psychology Expert + Parent Representatives | Concept design, child-friendly sound/light parameter testing, parent consultation | Implementation requires parent consent and child safety certification | Low-Medium | Park operator + equipment vendor | Child engagement duration, parent satisfaction ≥85% | Parent complaints / sound/light parameters exceed limits / safety hazards |
| P-06 | Mist-Light Corridor | Designer + Parks Dept + Municipal Water | Concept design, water usage assessment, mist equipment selection | Implementation requires parks dept water permit and municipal consent | Medium | Park operator + equipment vendor | Water efficiency, visitor satisfaction ≥75% | Drought water restriction / equipment failure / parks dept request |
| P-07 | Pulse Marker Tower | Designer + Planning Dept + Community | Concept design, height assessment, visual impact analysis | Implementation requires planning dept height permit and community consultation | Medium-High | Park operator | Landmark recognition, visitor photo rate | Planning dept disapproval / community opposition / safety hazards |
| P-08 | Qinghe Wind Corridor | Designer + Municipal Dept + Qinghe Manager | Concept design, wind device selection, safety assessment | Implementation requires municipal dept and Qinghe manager permits | Medium | Park operator + equipment vendor | Device uptime, visitor dwell time | High wind safety hazard / municipal request / equipment aging |
| P-09 | Pulse Morning-Run Lighting | Designer + Runner Community + Parks Dept | Concept design, lighting parameter testing, runner consultation | Implementation requires parks dept permit and power access consent | Low-Medium | Park operator | Runner usage rate, light sync accuracy | Resident complaints / power restrictions / equipment damage |
| P-10 | Pulse Data Wall | Designer + Data Governance Team + Park Operator | Concept design, data aggregation plan, privacy compliance assessment | Implementation requires PIA completion and data compliance review | Medium | Park operator + data team | Data delay <5min, privacy compliance 100% | Privacy complaints / data quality issues / compliance changes |
| P-11 | University Inspiration Corner | Designer + Universities + Community | Concept design, space function assessment, university partnership intent | Implementation requires university partnership agreement and community consent | Low | University + community joint operations | Space usage rate, monthly events | University withdrawal / space renovation / operations adjustment |
| P-12 | Corridor Building Renovation | Designer + Property Owners + Planning Dept + Heritage Authority | Concept design, building condition assessment, renovation feasibility study | Implementation requires property owner consent, planning dept permit, and heritage authority approval (if heritage buildings) | High | Property owner + operator | Renovation completion rate, tenant enterprise count | Property owner disagreement / planning disapproval / heritage restrictions |
| P-13 | Pillar Light Cascade Projection | Designer + Metro Operator + Heritage Authority + Community | Concept design, projection content production, pillar safety assessment | Implementation requires metro operator safety permit, heritage authority content review, and community consultation | Medium-High | Park operator + content team + equipment vendor | Train detection ≥95%, projection sync delay <500ms, resident satisfaction ≥75% | Metro operator request / after 21:30 / resident complaints / content review failure |
| P-14 | South–Middle Sidewalk Wayfinding | Designer + Transportation Dept + Community | Concept design, ground marking plan, traffic impact assessment | Implementation requires transportation dept road occupancy permit and community consent | Low | Park operator + municipal maintenance | Wayfinding recognition, gap passage rate | Transportation dept request / marking wear / road renovation |


| P-15 | AI Borderless Retail Experience Station | Commercial operator + tech vendor | Concept design, retail scenario testing, AI recommendation prototype | Implementation requires business operation permit and consumer protection review | Medium | Commercial operator + tech vendor | Consumer satisfaction, repurchase rate, AI recommendation accuracy | Consumer complaints exceed threshold / data compliance issues / operator exits |
| P-16 | Smart Business Service Pod | Business operator + tech vendor | Concept design, translation system testing, meeting minutes prototype | Implementation requires business service permit and data security review | Medium | Business operator + tech vendor | Service usage rate, user satisfaction, translation accuracy | User complaints / data compliance issues / operator exits |

> Note: All projects above are conceptual suggestions. Participating entities, cost tiers, KPIs, and exit conditions are conceptual-level judgments requiring professional development and relevant approvals before implementation. Conceptual timelines must not be treated as implementation commitments.
...
Phase areas: [metric:phase_1_area_sqm], [metric:phase_2_area_sqm], [metric:phase_3_area_sqm] m² [data:geometry/phasing.geojson].
...
![Core metrics and 15 scenario cards overview](assets/figures/metrics-evidence.en.png)
